...
When your global CLAUDE.md routes this edit to an implementation sub-agent, the sub-agent does not automatically read this file. Either perform the C1/C12 gates yourself before delegating, or include "read ~/Documents/Obsidian Vault/Claude Code/guardrails/CODE.md and follow C1, C12/REFERENCE SWEEP" in the sub-agent's prompt.
